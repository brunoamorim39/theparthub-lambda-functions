...
def find_vehicles():
    urls= ['https://www.infinitipartsonline.com/v-infiniti']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.infinitipartsonline.com'

url_file = Path('infinitipartsonline-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('infinitipartsonline-cats.json')
