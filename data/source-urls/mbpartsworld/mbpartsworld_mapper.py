...
def find_vehicles():
    urls= ['https://www.mbpartsworld.com/v-mercedes-benz']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.mbpartsworld.com'

url_file = Path('mbpartsworld-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('mbpartsworld-cats.json')
