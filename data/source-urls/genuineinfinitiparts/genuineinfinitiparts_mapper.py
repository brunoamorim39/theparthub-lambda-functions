...
def find_vehicles():
    urls= ['https://www.genuineinfinitiparts.com/v-infiniti']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.genuineinfinitiparts.com'

url_file = Path('genuineinfinitiparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('genuineinfinitipartse-cats.json')
