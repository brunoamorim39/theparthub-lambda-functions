...
def find_vehicles():
    urls= ['https://www.mercedesgenuineparts.com/v-mercedes-benz']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.mercedesgenuineparts.com'

url_file = Path('mercedesgenuineparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('mercedesgenuineparts-cats.json')
