...
def find_vehicles():
    urls= ['https://www.getporscheparts.com/v-porsche']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.getporscheparts.com'

url_file = Path('getporscheparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('getporscheparts-cats.json')
