        ...
        for model in models:
            ...
            for year in years:
                ...
                for driveline in drivelines:
                    driveline_url = 'https://www.factorychryslerparts.com' + driveline['href']
...
def find_categories():
    ...
    for link in links_to_check:
        ...
        for cat in cat_items:
            cat_url = 'https://www.factorychryslerparts.com' + cat['href']
...
main_url = 'https://www.factorychryslerparts.com'
site_name = 'factorychryslerparts'
