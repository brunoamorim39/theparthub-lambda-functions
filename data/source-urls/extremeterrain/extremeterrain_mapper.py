...
def find_vehicles():
    urls = [
        'https://www.extremeterrain.com/jeep-accessories-parts.html',
        'https://www.extremeterrain.com/jeep-gladiator-accessories-parts.html',
        'https://www.extremeterrain.com/ford-bronco-accessories-parts.html',
        'https://www.extremeterrain.com/toyota-tacoma-accessories-parts.html',
        'https://www.extremeterrain.com/toyota-tundra-accessories-parts.html'
    ]
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.extremeterrain.com'
site_name = 'extremeterrain'
