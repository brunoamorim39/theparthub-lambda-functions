...
def find_vehicles():
    urls= ['https://www.mbdirectparts.com/v-mercedes-benz']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.mbdirectparts.com'

url_file = Path('mbdirectparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('mbdirectparts-cats.json')
