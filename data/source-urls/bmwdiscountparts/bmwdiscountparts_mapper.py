...
def find_vehicles():
    urls= ['https://www.bmwdiscountparts.com/v-bmw', 'https://www.bmwdiscountparts.com/v-mini']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.bmwdiscountparts.com'

url_file = Path('bmwdiscountparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('bmwdiscountparts-cats.json')
