...
def find_vehicles():
    urls= ['https://www.audionlineparts.com/v-audi']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.audionlineparts.com'

url_file = Path('audionlineparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('audionlineparts-cats.json')
