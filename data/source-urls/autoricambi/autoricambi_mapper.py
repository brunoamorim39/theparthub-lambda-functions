...
def find_categories():
    ...
    for link in links_to_check:
        ...
        categories = vehicle_soup.find_all('a', class_='subcateogory-image-link', href=True)
        for category in categories:
            category_url = category['href']
            trimmed_url = f'/{category_url.split("/")[-2]}'
...
main_url = 'https://www.autoricambi.us'
site_name = 'autoricambi'
