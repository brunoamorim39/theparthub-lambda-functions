...
def find_vehicles():
    urls= ['https://www.genuineaudiparts.com/v-audi']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.genuineaudiparts.com'

url_file = Path('genuineaudiparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('genuineaudiparts-cats.json')
