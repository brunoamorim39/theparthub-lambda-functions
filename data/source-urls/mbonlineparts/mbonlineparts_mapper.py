...
def find_vehicles():
    urls= ['https://www.mbonlineparts.com/v-mercedes-benz', 'https://www.mbonlineparts.com/v-smart']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.mbonlineparts.com'

url_file = Path('mbonlineparts-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('mbonlineparts-cats.json')
