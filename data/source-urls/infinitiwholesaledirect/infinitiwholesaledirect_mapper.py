...
def find_vehicles():
    urls= ['https://www.infinitiwholesaledirect.com/v-infiniti']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.infinitiwholesaledirect.com'

url_file = Path('infinitiwholesaledirect-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('infinitiwholesaledirect-cats.json')
