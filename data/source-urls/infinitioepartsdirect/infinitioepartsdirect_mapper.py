...
def find_vehicles():
    urls= ['https://www.infinitioepartsdirect.com/v-infiniti']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.infinitioepartsdirect.com'

url_file = Path('infinitioepartsdirect-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('infinitioepartsdirect-cats.json')
