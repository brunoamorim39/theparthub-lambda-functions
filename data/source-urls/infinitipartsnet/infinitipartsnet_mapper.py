...
def find_vehicles():
    urls= ['https://www.infinitipartsnet.com/v-infiniti']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.infinitipartsnet.com'

url_file = Path('infinitipartsnet-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('infinitipartsnet-cats.json')
