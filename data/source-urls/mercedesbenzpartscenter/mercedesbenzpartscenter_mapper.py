...
def find_vehicles():
    urls= ['https://www.mercedesbenzpartscenter.com/v-mercedes-benz']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.mercedesbenzpartscenter.com'

url_file = Path('mercedesbenzpartscenter-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('mercedesbenzpartscenter-cats.json')
