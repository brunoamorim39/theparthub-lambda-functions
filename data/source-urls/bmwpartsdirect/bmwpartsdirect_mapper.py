...
def find_vehicles():
    urls= ['https://www.bmwpartsdirect.com/v-bmw']
    vehicle_links = []
    for url in urls:
...
main_url = 'https://www.bmwpartsdirect.com'

url_file = Path('bmwpartsdirect-urls.json')
url_file.touch(exist_ok=True)
cat_file = Path('bmwpartsdirect-cats.json')
