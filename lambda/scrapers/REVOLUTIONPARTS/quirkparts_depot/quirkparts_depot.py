...
def lambda_handler(event, context):
    ...
    base_URL = 'https://www.quirkparts.com'
    ...
    try:
        ...
        if soup.find('div', class_='catalog-products'):
            ...
            for listing in listings:
                ...
                listing_obj['source'] = 'quirkparts_depot.png'
        ...
        # FOR REDIRECT TO LISTING PAGE
            ...
            if container.find('img', class_='product-main-image'):
                product_photo = f"{container.find('img', class_='product-main-image')['src']}"
            else:
                product_photo = f"{container.find('img')['src']}"
